...
for cur_tgt in all_tgt:
    ...
    f1 = open('/home/ubuntu/OpenImagesDataset/machine_ann_2016_08/train/labels_'+str(cur_tgt)+'.csv', 'r')
    reader1 = csv.reader(f1)
    f2 = open('/home/ubuntu/OpenImagesDataset/images_2016_08/train/images.csv', 'r')
